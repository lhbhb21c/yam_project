...
app.controller("mstCtl", ($scope, $timeout, $filter, $window, uiGridConstants, blockUI) => {
    ...
    $scope.lfn_search = () => {
    	...
    	const param = {
    		queryId: "yam.cmmn.popup.ITM_POP.selMstList",
    		queryType:"selList",
    		param:$scope.ds_cond
    	}
    ...
    $scope.mstGrid = NG_GRD.instanceGridOptions({
		...
		customStateId	: "/yam/cmmn/popup/ITM_POP/mstGrid",
		columnDefs		:
			[
			 ...
			 {displayName:'단위',		field:'ITM_UN_NM',		width:'100',	type:'string',	cellClass:'align_cen'},
			 {displayName:'구분',		field:'ITM_GB_NM',		width:'100',	type:'string',	cellClass:'align_cen'},
			 {displayName:'공정',		field:'PROC_CD_NM',		width:'100',	type:'string',	cellClass:'align_cen'},
