...
<head>
    ...
    <script type="text/javascript" src="/WEBSERVER/yam/js/wm/WHIN_REG.js?ver=<%=YamConst.VER_WM_JS %>" charset="utf-8"></script>
    <!-- ====================================================================================================================================================== -->
		...
		<div block-ui="main" class="block-ui-main">
						...
						<div class="ibox-content">
							<div class="row">
								...
								<div class="col-sm-12 form-group">
									<label class="col-sm-1 control-label" label-mask>입고일자</label>
									<div class="col-sm-2">
										<div class="input-group">
											<div moment-picker="ds_mst.WHIN_DY"  change="lfn_input_onChange('ds_mst.WHIN_DY')"
													locale="ko" start-view="month" format="YYYY-MM-DD" class="ng-isolate-scope" style="display:inherit">
										    	<input ng-model="ds_mst.WHIN_DY" ng-disabled="lfn_input_disabled('ds_mst.WHIN_DY')" validTypes="required" validName="입고일자"
		                        	...
		                        	<label class="col-sm-1 control-label" label-mask>입고구분</label>
		                        	<div class="col-sm-2">
		                        		<select ng-model="ds_mst.WHIN_GB" ng-change="lfn_input_onChange('ds_mst.WHIN_GB')" ng-disabled="lfn_input_disabled('ds_mst.WHIN_GB')"
		                        				validTypes="required" validName="입고구분"	class="form-control">
                        					<option ng-repeat="x in ds_code.WHIN_GB_F" value="{{x.CODE_CD}}">{{x.CODE_NM}}</option>
                        				</select>
		                        	</div>
									...
									<label class="col-sm-1 control-label">입고번호</label>
									<div class="col-sm-1">
										<input ng-model="ds_mst.WHIN_NO" readonly class="form-control text-center" type="text" />
		                        	</div>
								</div>
								...
								<div class="col-sm-12 form-group">
									...
									<label class="col-sm-4 control-label">입고상태</label>
									<div class="col-sm-1">
										<select ng-model="ds_mst.WHIN_ST" ng-disabled="true" class="form-control">
											<option value="00">작성중</option>
                        					<option ng-repeat="x in ds_code.WHIN_ST" value="{{x.CODE_CD}}">{{x.CODE_NM}}</option>
                        				</select>
		                        	</div>
								</div>								
        	...
        	<div class="row">
				<div class="col-xs-12">
					<div class="ibox">
						<div class="ibox-title">
							<h5><i class="fa fa-list-alt"></i>입고품목</h5>
