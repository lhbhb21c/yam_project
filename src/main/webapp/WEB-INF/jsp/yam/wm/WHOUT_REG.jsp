...
<head>
    ...
    <script type="text/javascript" src="/WEBSERVER/yam/js/wm/WHOUT_REG.js?ver=<%=YamConst.VER_WM_JS %>" charset="utf-8"></script>
    <!-- ====================================================================================================================================================== -->
		...
		<div block-ui="main" class="block-ui-main">
						...
						<div class="ibox-content">
							<div class="row">
								...
								<div class="col-sm-12 form-group">
									<label class="col-sm-1 control-label" label-mask>출고일자</label>
									<div class="col-sm-2">
										<div class="input-group">
											<div moment-picker="ds_mst.WHOUT_DY"  change="lfn_input_onChange('ds_mst.WHOUT_DY')"
													locale="ko" start-view="month" format="YYYY-MM-DD" class="ng-isolate-scope" style="display:inherit">
										    	<input ng-model="ds_mst.WHOUT_DY" ng-disabled="lfn_input_disabled('ds_mst.WHOUT_DY')" validTypes="required" validName="출고일자"
		                        	...
		                        	<label class="col-sm-1 control-label" label-mask>출고구분</label>
		                        	<div class="col-sm-2">
		                        		<select ng-model="ds_mst.WHOUT_GB" ng-change="lfn_input_onChange('ds_mst.WHOUT_GB')" ng-disabled="lfn_input_disabled('ds_mst.WHOUT_GB')"
		                        				validTypes="required" validName="출고구분"	class="form-control">
                        					<option ng-repeat="x in ds_code.WHOUT_GB_F" value="{{x.CODE_CD}}">{{x.CODE_NM}}</option>
                        				</select>
		                        	</div>
									...
									<label class="col-sm-1 control-label">출고번호</label>
									<div class="col-sm-1">
										<input ng-model="ds_mst.WHOUT_NO" readonly class="form-control text-center" type="text" />
		                        	</div>
								</div>
								...
								<div class="col-sm-12 form-group">
		                        	...
		                        	<div class="col-sm-2">
										<div class="input-group">
			                                ...
			                                <div class="input-group-btn">
			                                    <button ng-click="lfn_btn_onClick('ds_mst.OD_NO')"	ng-disabled="lfn_btn_disabled('ds_mst.OD_NO')" ng-show="lfn_btn_show('ds_mst.OD_NO')" 
			                                    		class="btn btn-primary m-n"><i class="fa fa-search"></i></button>
			                                </div>
	                            		</div>
		                        	</div>
		                        	   
									<label class="col-sm-4 control-label">출고상태</label>
									<div class="col-sm-1">
										<select ng-model="ds_mst.WHOUT_ST" ng-disabled="true" class="form-control">
											<option value="00">작성중</option>
                        					<option ng-repeat="x in ds_code.WHOUT_ST" value="{{x.CODE_CD}}">{{x.CODE_NM}}</option>
                        				</select>
		                        	</div>
								</div>								
        	...
        	<div class="row">
				<div class="col-xs-12">
					<div class="ibox">
						<div class="ibox-title">
							<h5><i class="fa fa-list-alt"></i>출고품목</h5>
