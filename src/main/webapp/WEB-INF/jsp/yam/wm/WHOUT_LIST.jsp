...
<head>
    ...
    <script type="text/javascript" src="/WEBSERVER/yam/js/wm/WHOUT_LIST.js?ver=<%=YamConst.VER_WM_JS %>" charset="utf-8"></script>
    <!-- ====================================================================================================================================================== -->
		...
		<div block-ui="main" class="block-ui-main">
					...
					<div class="ibox">
						...
						<div class="ibox-content row" style="overflow:visible;">
	                        ...
	                        <div class="col-sm-12 form-group">
                                ...
                                <label class="col-sm-1 control-label">출고일</label>
	                        	<div class="col-sm-3">
	                        	...
	                        	<label class="col-sm-1 control-label">출고구분</label>
	                        	<div class="col-sm-1">
									<multicombo multi-combo sel-model="ds_cond.WHOUT_GBS" list-model="ds_code.WHOUT_GB"></multicombo>
	                        	</div>	                      	 
        	...
        	<div class="row">
				<div class="col-lg-12">
					<div class="ibox"  style="margin-bottom:0;">
						<div class="ibox-title">
							<h5><i class="fa fa-list-alt"></i>출고목록</h5>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="ibox"  style="margin-bottom:0;">
						<div class="ibox-title">
							<h5><i class="fa fa-list-alt"></i>출고상세</h5>
							<div class="btn-group pull-right"></div>
						</div>
