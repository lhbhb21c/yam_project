...
<head>
	...
	<!-- ====================================================================================================================================================== -->
	<!-- 페이지별 SCRIPT, CSS -->
	<script type="text/javascript" src="/WEBSERVER/yam/js/cmmn/popup/SIO_ITM_POP.js?ver=<%=YamConst.VER_POPUP_JS %>" charset="utf-8"></script>
    <!-- ====================================================================================================================================================== -->
					...
					<div class="ibox">
						<div class="ibox-content i-box-search">
							<div class="col-sm-12 form-group">
								<label class="col-sm-2 control-label">품목 코드/명</label>
								<div class="col-sm-3">
									<input ng-model="ds_cond.ITM_CD" ng-enter="lfn_btn_onClick('SEARCH')" kr-input class="form-control" type="text">
								</div>
							</div>
						</div>
					</div>
