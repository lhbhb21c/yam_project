...
<head>
	...
	<script type="text/javascript" src="/WEBSERVER/yam/js/mm/ITM_MNG_STD.js?ver=<%=YamConst.VER_MM_JS %>" charset="utf-8"></script>
	<!-- ====================================================================================================================================================== -->
							...
							<div id="ds_mst" class="ibox-content">
								<div class="row row-full-height">
									...
									<div class="col-sm-12 form-group">
										...
										<div class="col-sm-4">
											<input ng-model="ds_mst.ITM_CD"	ng-disabled="lfn_input_disabled('ds_mst.ITM_CD')"	ng-change="lfn_input_onChange('ds_mst.ITM_CD')"	validTypes="required"	validName="품목코드"	class="form-control" type="text" />
										</div>
