...
<head>
    ...
    <script type="text/javascript" src="/WEBSERVER/yam/js/sm/DO_LIST.js?ver=<%=YamConst.VER_PC_JS %>" charset="utf-8"></script>
    <!-- ====================================================================================================================================================== -->
					...
					<div class="ibox">
						<div class="ibox-title">
							...
							<div class="ibox-tools">
								...
								<button ng-click="lfn_btn_onClick('REG')"		ng-disabled="lfn_btn_disabled('REG')"		ng-show="lfn_btn_show('REG')"		class="btn btn-warning btn-tbb" type="button"><i class="fa fa-check-square-o" aria-hidden="true"></i> 출하지시등록</button>
						...
						<div class="ibox-content row" style="overflow:visible;">
	                        ...
	                        <div class="col-sm-12 form-group">
                                ...
                                <label class="col-sm-1 control-label">출하일</label>
	                        	<div class="col-sm-3">
	                        	...
	                        	<div class="col-sm-1">
									<multicombo multi-combo sel-model="ds_cond.DO_GBS" list-model="ds_code.DO_GB"></multicombo>
	                        	</div>	                      	 
	                        	
	                        	<label class="col-sm-1 control-label">상태</label>
	                        	<div class="col-sm-1">
									<multicombo multi-combo sel-model="ds_cond.DO_STS" list-model="ds_code.DO_ST"></multicombo>
	                        	</div>	                      	 
        	...
        	<div class="row">
				<div class="col-lg-12">
					<div class="ibox"  style="margin-bottom:0;">
						<div class="ibox-title">
							<h5><i class="fa fa-list-alt"></i>출하지시 목록</h5>
