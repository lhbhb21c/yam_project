...
<head>
    ...
    <script type="text/javascript" src="/WEBSERVER/yam/js/sm/TR_AGGR_LIST.js?ver=<%=YamConst.VER_SM_JS %>" charset="utf-8"></script>
    <!-- ====================================================================================================================================================== -->
					...
					<div class="ibox">
						...
						<div class="ibox-content row" style="overflow:visible;">
	                        ...
	                        <div class="col-sm-12 form-group">
	                        	...
	                        	<div class="col-sm-1">
									<multicombo multi-combo sel-model="ds_cond.TR_AGGR_TMS" list-model="ds_code.TR_AGGR_TM"></multicombo>
	                        	</div>	                      	 
