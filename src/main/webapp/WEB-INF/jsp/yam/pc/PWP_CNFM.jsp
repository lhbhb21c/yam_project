...
<head>
	...
	<script type="text/javascript" src="/WEBSERVER/yam/js/pc/PWP_CNFM.js?ver=<%=YamConst.VER_PC_JS %>" charset="utf-8"></script>
	<!-- ====================================================================================================================================================== -->
				...
				<div class="ibox">
					<div class="ibox-title">
						...
						<div class="ibox-tools">
							...
							<button ng-click="lfn_btn_onClick('CONFIRM')"	ng-disabled="lfn_btn_disabled('CONFIRM')"	ng-show="lfn_btn_show('CONFIRM')"	class="btn btn-warning btn-tbb" type="button"><i class="fa fa-check-square-o"></i> 일괄확정</button>
					...
					<div class="ibox-content row" style="overflow:visible;">
						...
						<div class="col-sm-12 form-group">
							...
							<label class="col-sm-1 control-label">생산일</label>
							<div class="col-sm-3">
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="ibox"  style="margin-bottom:0;">
					<div class="ibox-title">
						<h5><i class="fa fa-list-alt"></i>작업실적확정 목록</h5>
