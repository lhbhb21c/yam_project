...
<head>
    ...
    <script type="text/javascript" src="/WEBSERVER/yam/js/pc/PWP_INPUT.js?ver=<%=YamConst.VER_PC_JS %>" charset="utf-8"></script>
    <!-- ====================================================================================================================================================== -->
	                        ...
	                        <div class="col-sm-12 form-group">
	                        	...
	                        	<div class="col-sm-1">
                                    <div class="input-group"  style="width: 100%;">
										<div moment-picker="ds_cond.YYYY" locale="ko" start-view="year" format="YYYY" class="ng-isolate-scope" style="display:inherit">
									    	<input ng-model="ds_cond.YYYY" ng-model-options="{ updateOn: 'blur' }"	class="form-control ng-pristine ng-untouched ng-valid ng-scope moment-picker-input ng-not-empty align_cen" >
