...
<head>
    ...
    <script type="text/javascript" src="/WEBSERVER/yam/js/pc/PWP_CLOSE.js?ver=<%=YamConst.VER_PC_JS %>" charset="utf-8"></script>
    <!-- ====================================================================================================================================================== -->
		...
		<div block-ui="main" class="block-ui-main">
					...
					<div class="ibox">
						<div class="ibox-title">
							...
							<div class="ibox-tools">
								...
								<button ng-click="lfn_btn_onClick('CONFIRM')"	ng-disabled="lfn_btn_disabled('CONFIRM')"	ng-show="lfn_btn_show('CONFIRM')"	class="btn btn-warning btn-tbb" type="button"><i class="fa fa-envelope-o"></i> 수정확정</button>
	                        ...
	                        <div class="col-sm-12 form-group">
	                        	...
	                        	<div class="col-sm-1">
	                        		<div class="input-group">
		                        		<div moment-picker="ds_cond.YM" style="display:inherit" class="ng-isolate-scope" locale="ko" start-view="month" format="YYYY-MM">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="ibox"  style="margin-bottom:0;">
						<div class="ibox-title">
							<h5><i class="fa fa-list-alt"></i>투입내역</h5>
							<div class="btn-group pull-right"></div>
						</div>
