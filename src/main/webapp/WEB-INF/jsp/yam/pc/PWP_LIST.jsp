...
<head>
    ...
    <script type="text/javascript" src="/WEBSERVER/yam/js/pc/PWP_LIST.js?ver=<%=YamConst.VER_PC_JS %>" charset="utf-8"></script>
    <!-- ====================================================================================================================================================== -->
					...
					<div class="ibox">
						...
						<div class="ibox-content row" style="overflow:visible;">
	                        ...
	                        <div class="col-sm-12 form-group">
	                        	...
	                        	<label class="col-sm-1 control-label">취소포함</label>
	                        	<div class="col-sm-1">
									<input ng-model="ds_cond.INC_CNC_YN" ng-true-value="'Y'" ng-false-value="'N'" type="checkbox" style="height:20px"/>
	                        	</div>
        	...
        	<div class="row">
				<div class="col-lg-12">
					<div class="ibox"  style="margin-bottom:0;">
						<div class="ibox-title">
							<h5><i class="fa fa-list-alt"></i>작업실적 목록</h5>
