...
<head>
	...
	<!-- ====================================================================================================================================================== -->
	<!-- 페이지별 SCRIPT, CSS -->
	<script type="text/javascript" src="/WEBSERVER/we_std/js/popup/PARTNR_SEL_POP.js?ver=20220329" charset="utf-8"></script>
    <!-- ====================================================================================================================================================== -->
					...
					<div class="ibox">
						<div class="ibox-content i-box-search">
							<div class="col-sm-12 form-group">
								...
								<div class="col-sm-3">
									<input ng-model="ds_cond.PARTNR_NM" ng-enter="lfn_btn_onClick('SEARCH')" kr-input class="form-control" type="text">
								</div>
							</div>
						</div>
					</div>
